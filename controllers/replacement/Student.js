const StudentReplacement = require("../../models/replacement/Staff");
const StudentRequest = require("../../zscripts/student-requests/StudentRequests");

class StudentIdReplacement {
  static async ApplyForReplacement(req, res) {
