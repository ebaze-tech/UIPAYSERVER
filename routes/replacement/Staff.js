...
const StaffReplacementController = require("../../controllers/replacement/Staff");
...
router.post(
  ...
  authenticate,
  authorize("Staff"),
  StaffReplacementController.ApplyForReplacement
);
...
//   replacementValidation,
//   authorize("Staff"),
//   StaffReplacementController.UpdateReplacement
// );
